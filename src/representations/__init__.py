...
while ``plasma_context`` provides the shared memory-mapped reader and
training-only scaling for the aligned 16-value context. PCA owns its
restartable feature-batch iterator in the analysis package.
"""
