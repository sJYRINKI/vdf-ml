# python scripts/predict_perceptron_region.py --config configs/predict_region_perceptron.yaml --start-timestep 1300 --n-timesteps 100 --model-id v1.0 --file-source 3d
