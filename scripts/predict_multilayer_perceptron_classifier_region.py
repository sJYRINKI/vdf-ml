# python scripts/predict_multilayer_perceptron_classifier_region.py --config configs/predict_region_multilayer_perceptron_classifier.yaml --start-timestep 1300 --n-timesteps 100 --model-id v1.0 --file-source 3d
